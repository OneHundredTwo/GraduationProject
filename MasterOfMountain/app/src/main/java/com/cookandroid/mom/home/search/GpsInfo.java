...
/**
 * Created by RJH on 2017-10-20.
 */

public class GpsInfo extends Service implements LocationListener {
    private final Context mContext;
    private final MtSearchActivity mActivity;
    // 현재 GPS 사용유무
    ...
    public GpsInfo(Context context, MtSearchActivity mActivity) {
        this.mContext = context;
        this.mActivity = mActivity;
        getLocation();

        mActivity.realTimeLati = lat;
        mActivity.realTimeLongi = lon;
    }
