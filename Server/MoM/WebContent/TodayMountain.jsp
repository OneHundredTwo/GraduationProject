...
<% 
	...
	try{
		...
		String sql = "select a.*, c.category from todaymt a, mountain b, area_category c where a.mtNum = b.mNum and b.mArea = c.mArea and isshow=1 order by todaymt_num desc";
		...
		responseJSON.put("toMts", jsonArr);
